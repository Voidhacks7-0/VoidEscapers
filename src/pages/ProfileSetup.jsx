...
import { User, Ruler, Weight, Activity, ArrowRight, Building2 } from 'lucide-react';
        ...
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-2xl bg-slate-900/60 border border-slate-800 rounded-3xl p-8 backdrop-blur-xl shadow-2xl relative z-10">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-black text-white tracking-tight mb-2">Welcome to VitaTrack</h1>
                    <p className="text-slate-400">Let's get to know you better to personalize your health journey.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                >
                                    ...
                                    <option value="athlete">Extra Active (Physical job or training)</option>
                                </select>
                            </div>
                            <div className="space-y-2">
                    ...
                    <div className="space-y-4 pt-4 border-t border-slate-800">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-slate-300">Do you have any existing conditions?</label>
                    ...
                    {/* Education Section */}
                    <div className="space-y-4 pt-4 border-t border-slate-800">
                        <h3 className="text-sm font-bold text-violet-400 uppercase tracking-wider mb-4">Education (Optional)</h3>
                        <div className="space-y-2">
                            ...
                            {colleges.length === 0 && (
                                <p className="text-xs text-slate-500 mt-1">No colleges found. Ask admin to add one.</p>
                            )}
                        </div>
                    </div>
